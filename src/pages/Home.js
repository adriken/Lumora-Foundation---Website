...
// ─── IMAGE IMPORTS ────────────────────────────────────────────────────────────
// STEP 1: Save your images into src/images/
// STEP 2: Uncomment the imports below and delete the placeholder divs
  ...
  return (
    <>
      ...
      <section className="hero">
        ...
        {/* ── Hero Background ──
            OPTION A (current): gradient only — no image needed
            OPTION B: add your photo
              1. Save photo to src/images/hero-bg.jpg
              2. Uncomment the import at top of file
              3. Replace <div className="hero-bg" /> with:
                 ...
                 Then add a dark overlay inside .hero-bg using ::after in CSS
        ── */}
        ...
        <div className="hero-content">
          ...
          <div className="hero-actions">
            ...
            <a href="#" className="btn-secondary" onClick={e => { e.preventDefault(); setPage("Missions"); }}>
              Our Mission →
            </a>
            <a href="#" className="btn-ghost" onClick={e => { e.preventDefault(); setPage("Stories"); }}>
              ▶ Watch Stories
            </a>
          </div>
        </div>
        ...
        <div className="about-grid">
          <FadeIn>
            ...
            <p className="section-body" style={{ marginBottom: 24 }}>
              Lumora Foundation was born from witnessing the painful intersection
              of two crises: children sleeping hungry in rural Kenya, and brilliant
              girls denied the future they deserve simply because they are girls.
            </p>
            <p className="section-body" style={{ marginBottom: 36 }}>
              We don't just provide food and devices. We dismantle the systems of
              inequality that created these crises — one meal, one line of code,
          ...
          <FadeIn delay={0.15}>
            {/* ── ABOUT PHOTO ──
                CURRENT: shows a placeholder box
                TO ADD YOUR PHOTO:
                  1. Save photo to src/images/about-team.jpg
                  2. Uncomment the import at top: import aboutPhoto from "../images/about-team.jpg"
                  3. Replace the entire <div className="about-img-placeholder"> block below with:
                     <img src={aboutPhoto} alt="Lumora team" style={{ width:'100%', aspectRatio:'4/5', objectFit:'cover', borderRadius:20 }} />
            ── */}
          ...
          <FadeIn>
            <div style={{ textAlign: "center", marginBottom: 8 }}>
              ...
              <p className="section-body" style={{ margin: "0 auto", textAlign: "center" }}>
                Kenya sits at a critical inflection point — a young, fast-growing nation with immense potential,
                constrained by hunger, inequality, and a digital gender gap that costs the economy billions.
              </p>
            </div>
          </FadeIn>
        ...
        <FadeIn>
          <div className="vision-banner">
            <div className="vision-quote">
              "We are not building a charity. We are building the infrastructure
              of a transformed Kenya — one that is fed, educated, and led by the
              women the world underestimated."
            </div>
            ...
            {[
              {
                ...
                // image: testimonialA   ← uncomment after adding image
              },
              {
              ...
              <FadeIn key={i} delay={i * 0.1}>
                <div className="testimonial-card">
                  ...
                  <div className="testimonial-author">
                    {/* ── TESTIMONIAL PHOTO ──
                        CURRENT: shows coloured initial circle
                        TO ADD PHOTO:
                          1. Save to src/images/testimonial-amina.jpg (etc.)
                          2. Import at top of file
                          3. Replace <div className="author-avatar"> with:
                             <img src={t.image} alt={t.name} className="author-avatar" style={{ objectFit:'cover' }} />
                    ── */}
